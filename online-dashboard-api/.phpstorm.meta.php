...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.oauth_token_uri' => 'string',
            'auth.reset_password_expiry_time_limit' => 'integer',
            ...
            'filesystems.disks.google.folderId' => 'NULL',
            'filesystems.links.C:\Users\SAILS-DM219\Desktop\Project\BTechCareerguide-Online-Dashboard\online-dashboard-api\public\storage' => 'string',
            'github.user_lookup_url' => 'string',
            'github.add_collaborator_url' => 'string',
            'home.social.youtube.label' => 'string',
            'home.social.youtube.subscribers' => 'string',
            'home.social.youtube.url' => 'string',
            'home.social.telegram.label' => 'string',
            'home.social.telegram.followers' => 'string',
            'home.social.telegram.url' => 'string',
            'home.social.whatsapp.label' => 'string',
            'home.social.whatsapp.members' => 'string',
            'home.social.whatsapp.url' => 'string',
            'home.social.linkedin.label' => 'string',
            'home.social.linkedin.connections' => 'string',
            'home.social.linkedin.url' => 'string',
            'home.social.instagram.label' => 'string',
            'home.social.instagram.connections' => 'string',
            'home.social.instagram.url' => 'string',
            'home.jobs' => 'object',
            'home.stats.jobs' => 'string',
            'home.stats.projects' => 'string',
            'home.stats.developers' => 'string',
            'home.stats.students' => 'string',
            'home.testimonials' => 'object',
            'home.companies' => 'array',
            ...
            'passport.password_client.id' => 'string',
            'passport.password_client.secret' => 'string',
            ...
            'standard-data.degrees' => 'array',
            'standard-data.branches.CSE' => 'string',
            'standard-data.branches.IT' => 'string',
            'standard-data.branches.ECE' => 'string',
            'standard-data.branches.EE' => 'string',
            'standard-data.branches.ME' => 'string',
            'standard-data.branches.CE' => 'string',
            'standard-data.branches.AIML' => 'string',
            'standard-data.branches.DS' => 'string',
            'standard-data.branches.MT' => 'string',
            'standard-data.branches.CHE' => 'string',
            'standard-data.branches.IE' => 'string',
            'standard-data.job_types' => 'array',
            'standard-data.batches' => 'array',
            'standard-data.skills' => 'array',
            'standardjobkeys.company_name' => 'array',
            'standardjobkeys.role' => 'array',
            'standardjobkeys.experience' => 'array',
            'standardjobkeys.ctc' => 'array',
            'standardjobkeys.apply_link' => 'array',
            'standardjobkeys.batch' => 'array',
            'standardjobkeys.degree' => 'array',
            'standardjobkeys.location' => 'array',
            'standardjobkeys.job_type' => 'array',
            'standardjobkeys.branch' => 'array',
            'standardjobkeys.company_logo' => 'array',
...
'auth.passwords.users.table','auth.passwords.users.expire','auth.passwords.users.throttle','auth.password_timeout','auth.oauth_token_uri',
'auth.reset_password_expiry_time_limit','cache.default','cache.stores.array.driver','cache.stores.array.serialize','cache.stores.database.driver',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.google.driver','filesystems.disks.google.clientId','filesystems.disks.google.clientSecret',
'filesystems.disks.google.refreshToken','filesystems.disks.google.folderId','filesystems.links.C:\\Users\\SAILS-DM219\\Desktop\\Project\\BTechCareerguide-Online-Dashboard\\online-dashboard-api\\public\\storage','github.user_lookup_url','github.add_collaborator_url',
'home.social.youtube.label','home.social.youtube.subscribers','home.social.youtube.url','home.social.telegram.label','home.social.telegram.followers',
'home.social.telegram.url','home.social.whatsapp.label','home.social.whatsapp.members','home.social.whatsapp.url','home.social.linkedin.label',
'home.social.linkedin.connections','home.social.linkedin.url','home.social.instagram.label','home.social.instagram.connections','home.social.instagram.url',
'home.jobs','home.stats.jobs','home.stats.projects','home.stats.developers','home.stats.students',
'home.testimonials','home.companies','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'passport.connection','passport.client_uuids','passport.personal_access_client.id','passport.personal_access_client.secret','passport.password_client.id',
'passport.password_client.secret','permission.models.permission','permission.models.role','permission.table_names.roles','permission.table_names.permissions',
...
'queue.failed.database','queue.failed.table','razorpay.key','razorpay.secret','services.postmark.token',
...
'session.same_site','session.partitioned','standard-data.degrees','standard-data.branches.CSE','standard-data.branches.IT',
'standard-data.branches.ECE','standard-data.branches.EE','standard-data.branches.ME','standard-data.branches.CE','standard-data.branches.AIML',
'standard-data.branches.DS','standard-data.branches.MT','standard-data.branches.CHE','standard-data.branches.IE','standard-data.job_types',
'standard-data.batches','standard-data.skills','standardjobkeys.company_name','standardjobkeys.role','standardjobkeys.experience',
'standardjobkeys.ctc','standardjobkeys.apply_link','standardjobkeys.batch','standardjobkeys.degree','standardjobkeys.location',
'standardjobkeys.job_type','standardjobkeys.branch','standardjobkeys.company_logo','broadcasting.default','broadcasting.connections.reverb.driver',
...
'passport.clients.destroy','passport.scopes.index','passport.personal.tokens.index','passport.personal.tokens.store','passport.personal.tokens.destroy','testimonials.index',
'testimonials.store','testimonials.show','testimonials.update','testimonials.destroy','storage.local',);
        registerArgumentsSet('views', 
'resetPassword','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'C:.Users.SAILS-DM219.Desktop.Project.BTechCareerguide-Online-Dashboard.online-dashboard-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.Users.SAILS-DM219.Desktop.Project.BTechCareerguide-Online-Dashboard.online-dashboard-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name','laravelEnum::C:.Users.SAILS-DM219.Desktop.Project.BTechCareerguide-Online-Dashboard.online-dashboard-api.vendor.bensampo.laravel-enum.lang.en.messages.enum','laravelEnum::C:.Users.SAILS-DM219.Desktop.Project.BTechCareerguide-Online-Dashboard.online-dashboard-api.vendor.bensampo.laravel-enum.lang.en.messages.enum_value','laravelEnum::C:.Users.SAILS-DM219.Desktop.Project.BTechCareerguide-Online-Dashboard.online-dashboard-api.vendor.bensampo.laravel-enum.lang.en.messages.enum_key',);
...
'VITE_APP_NAME','PASSWORD_GRANT_CLIENT_ID','PASSWORD_GRANT_CLIENT_SECRET','GITHUB_TOKEN','RAZORPAY_KEY',
'RAZORPAY_SECRET','FILESYSTEM_CLOUD','GOOGLE_DRIVE_CLIENT_ID','GOOGLE_DRIVE_CLIENT_SECRET','GOOGLE_DRIVE_REFRESH_TOKEN',
'GOOGLE_DRIVE_FOLDER',);
