...
//     } lg:fixed lg:h-screen lg:w-1/6 lg:translate-x-0 lg:z-10`} // For mobile, slides in/out, on desktop it's fixed
...
//           <Link to="/user/jobs" className="flex items-center space-x-1">
//             <i className="fa fa-graduation-cap"></i>
//             <span>Jobs</span>
//           </Link>
//         </li>
//         <li className="flex items-center space-x-2 cursor-pointer hover:text-indigo-800 transition">
//           <Link to="/user/projects" className="flex items-center space-x-2">
//             <i className="fa fa-trophy"></i>
//             <span>Projects</span>
//           </Link>
//         </li>
//         <li className="flex items-center space-x-2 cursor-pointer hover:text-indigo-800 transition">
//           <Link to="/user/company-qa" className="flex items-center space-x-2">
