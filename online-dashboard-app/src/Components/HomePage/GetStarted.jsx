  ...
  return (
    <div className="w-full lg:w-6/12 h-full flex flex-col items-center text-center lg:text-left pb-4 md:pb-0 justify-center">
      <div className="space-y-3 mt-12 lg:mt-0">
        ...
        <button onClick={()=>handleGetStartedClick(true)} className="font-semibold text-violet-900 p-2 px-6 border-2 border-gray-300 hover:border-slate-50 hover:text-slate-50">
          Get Started
        </button>
        <a href="https://www.youtube.com/@btechcareerguide" target="_blank" rel="noopener noreferrer"><button className="font-semibold text-slate-50 p-2 px-6 border-2 ml-2 border-gray-300 hover:border-slate-50 hover:text-slate-50">
          YouTube
        </button></a>
      </div>
    </div>
