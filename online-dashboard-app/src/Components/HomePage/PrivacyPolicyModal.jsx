      ...
      <div className="bg-white rounded-xl max-w-3xl w-full relative max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="bg-white px-6 md:px-10 py-4 md:py-6 border-b border-gray-200 sticky top-0 z-10">
          <div className="flex justify-between items-center">
            <h2 className="text-2xl font-display font-semibold text-violet-800">
              Privacy Policy
            </h2>
            <button
              onClick={onClose}
        ...
        <div className="overflow-y-auto px-6 md:px-10 py-4 space-y-4 text-sm text-gray-700">
          ...
          <p>
            ...
            information you provide while using our services.
          </p>
          ...
          <p>
            ...
            to comply with legal obligations or improve our service via trusted
            service providers.
          </p>

          <h3 className="font-semibold text-gray-800 font-sans">Your Rights</h3>
          <p>
            You can request access to, update, or delete your personal data at
          ...
          <p>
            ...
            reach out at{" "}
            <span className="text-violet-900">btechcareerguide@gmail.com</span>
          </p>
        </div>
      </div>
    </div>
