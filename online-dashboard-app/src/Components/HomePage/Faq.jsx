...
const faqs = [
  {
    ...
    answer:
      "Trending Jobs features the most in-demand roles across industries, updated regularly based on market trends.",
  },
  {
    question: "What information is provided in the About Us section?",
    answer:
      "The About Us section shares our mission, vision, and the story behind our platform to help users understand our purpose.",
  },
  {
    question: "What services do you offer?",
    answer:
      "We offer job listing, resume assistance, career guidance, and employer collaboration services.",
  },
  {
    question: "Where can I find answers to common user questions?",
    answer:
      "You can visit our FAQs section for quick answers to the most common queries about our platform and services.",
  },
  {
    question: "How can I get in touch with you?",
    answer:
      "Reach out to us via the Contact Us page using the form provided or through the listed email and phone number.",
  },
];
