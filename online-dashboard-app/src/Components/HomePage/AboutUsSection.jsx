        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center items-start md:pl-10 text-center md:text-left mt-6 md:mt-0">
          ...
          >
            ...
            <p className="text-gray-600 text-lg max-w-xl mb-6">
              We blend creativity, technology, and strategy to craft solutions
              that inspire. With a passionate team and customer-first approach,
            ...
            <div className="flex gap-4 md:justify-start justify-center items-center">
              ...
              <button
                ...
                className="border border-gray-400 text-gray-700 px-6 py-2 rounded-full hover:border-gray-600 transition flex justify-center items-center"
              >
                Explore
