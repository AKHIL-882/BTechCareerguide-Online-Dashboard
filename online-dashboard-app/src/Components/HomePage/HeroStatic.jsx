      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-32">
        ...
        <div className="flex items-center space-x-4">
          <div className="bg-blue-100 text-blue-600 rounded-full p-4">
            {/* YouTube SVG */}
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="text-red-600">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 font-sans whitespace-nowrap">
              <CountUpOnScroll end={2500} duration={3} />+ Subscribers
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          <div className="bg-blue-100 text-blue-600 rounded-full p-4">
            {/* Telegram SVG */}
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="text-blue-500">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 font-sans whitespace-nowrap">
              <CountUpOnScroll end={600} duration={3} />+ Followers
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          <div className="bg-blue-100 text-blue-600 rounded-full p-4">
            {/* WhatsApp SVG */}
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="text-green-500">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 font-sans whitespace-nowrap">
              <CountUpOnScroll end={2500} duration={3} />+ Members
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          <div className="bg-blue-100 text-blue-600 rounded-full p-4">
            {/* LinkedIn SVG */}
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="text-blue-700">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 font-sans whitespace-nowrap">
              <CountUpOnScroll end={100} duration={3} />+ Connections
            </p>
          </div>
        </div>
      </div>
