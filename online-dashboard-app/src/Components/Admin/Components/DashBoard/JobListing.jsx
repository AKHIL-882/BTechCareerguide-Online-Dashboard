...
const handleDelete = (id) => {
  deleteJob(id, jobListings, setJobListings, setShowDeletePopup, setJobToDelete);
};
  ...
  return (
    <div className="mx-auto p-4 rounded-lg shadow-lg">
      <h1 className="text-xl font-bold mb-4 text-gray-900">Job Listings <span className="text-sm text-gray-800">({jobListings.length})</span></h1>
