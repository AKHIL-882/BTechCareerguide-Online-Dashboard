...
const Header = ({ handleLogout, isCollapsed }) => {
  ...
  return (
    <header className="hidden lg:flex justify-between items-center px-6 md:py-2 py-3 w-full h-14 fixed top-0 left-0 right-0 z-10 bg-slate-50 dark:bg-gray-950 text-slate-900 dark:text-slate-100 border-b border-gray-200 dark:border-gray-800">
      <h1
