...
const Dashboard = () => {
  ...
  return (
    <main className="m-3 flex-1 pt-10 pb-8 lg:relative bg-slate-50 dark:bg-gray-950 text-slate-900 dark:text-slate-100 min-h-screen space-y-8">
              ...
              <div className="overflow-x-auto pb-1">
                <div className="flex gap-4 min-w-[280px]">
                  {highlightJobs.map((job) => (
                    <div
                      key={job.id}
                      className="min-w-[280px] flex-1 relative overflow-hidden rounded-xl border border-gray-200 dark:border-gray-800 bg-gradient-to-br from-slate-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-950 dark:to-indigo-950/30 p-4 shadow-sm"
                    >
        ...
        <div className="xl:col-span-2 space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h2 className="text-xl font-semibold">Latest projects to practice</h2>
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Build portfolio-ready projects and showcase your skills.
              </p>
            </div>
            <Link
              to="/projects"
